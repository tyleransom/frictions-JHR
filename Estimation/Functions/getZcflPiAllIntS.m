function [Z,pimat] = getZcflPiAllIntS(draws,ARcov,ARcov2,yr,ager,LEi,LYi,experer,typer,birthLoc,birthDiv,urate_lag55,J,rho_hat_urate,bLemp,bLunemp,rho_hat_wage,bwage,shock_amt,distance,Beta)
...
for dd=1:draws
	...
	for jj=1:nloc
        pimat1(1,1) = squeeze(lambdervecRhoCflPiAllIntS(nloc,l,Tmater,yr-2003,urate_lag55,0,1,experer,typer,rho_hat_urate,1,squeeze(shocker(1,(l-1)*2+2,:))',bLemp,bLunemp,corru(l,:),shock_amt));
