function w = ewagevecRhoCflWageAll(nloc,shock_corr,shock_amt,j,Tmat,Tvec,r,t,e,b)
...
if all(j>nloc)
    ...
    w = [ones(size(e)) locer timer loctimer e e.^2./100]*b + (r2^t)*shock_amt*shock_corr(j);
