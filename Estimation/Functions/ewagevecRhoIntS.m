function w = ewagevecRhoIntS(nloc,j,Tmat,Tvec,r,t,e,type,b,err)
...
if all(j>nloc)
    ...
    w = repmat([ones(size(e)) locer timer loctimer e e.^2./100 type==1]*b,[1 size(err,2)]);
