function w = ewagevecRhoCflWageIntS(nloc,shock_loc,shock_amt,j,Tmat,Tvec,r,t,e,type,b,err)
...
if all(j>nloc)
    ...
    w = repmat([ones(size(e)) locer timer loctimer e e.^2./100 type==1]*b + (r2^t)*shock_amt*(j==shock_loc),[1 size(err,2)]);
