...
set more off
capture log close
log using an_sipp_urmm.log, replace
...
preserve
	...
	graph export mobility_urmm_employed.eps, replace
	...
	graph twoway ///(area c2             year if inrange(year,2004,2013)                ,              color(gs15)  )  /// recession
				 ...
				 legend(label(1 "Recession") label(2 "Within state") label(3 "Between states") cols(2)) ytitle("Annual Migration Rate (%)") xtitle("Year") ylabel(0(.5)`cheight') xlabel(2004(1)2013) graphregion(color(white))
	graph export mobility_urmm_nonemployed.eps, replace
restore
...
preserve
	...
	graph twoway (area c2             year if inrange(year,2004,2013)           ,              color(gs15)  )  /// recession
				 ...
				 legend(label(1 "Recession") label(2 "Within state") label(3 "Between states") cols(2)) ytitle("Annual Migration Rate (%)") xtitle("Year") ylabel(0(.5)`cheight') xlabel(2004(1)2013) graphregion(color(white))
	graph export mobility_urmm_curr_employed.eps, replace
	...
	graph twoway (area c2             year if inrange(year,2004,2013)           ,              color(gs15)  )  /// recession
				 ...
				 legend(label(1 "Recession") label(2 "Within state") label(3 "Between states") cols(2)) ytitle("Annual Migration Rate (%)") xtitle("Year") ylabel(0(.5)`cheight') xlabel(2004(1)2013) graphregion(color(white))
	graph export mobility_urmm_curr_nonemployed.eps, replace
restore
